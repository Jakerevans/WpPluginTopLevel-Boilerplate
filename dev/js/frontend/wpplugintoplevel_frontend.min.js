...
jQuery( document ).ready( function( $ ) {
    ...
    wppluginToplevelActuallySaveUserPost();

	/* ENDING SECTION TO CALL ALL FUNCTIONS IN FILE... */

    // Function to actually save a post to a Users' account
    function wppluginToplevelActuallySaveUserPost(){

        $( document ).on( 'click', '.wpplugin-save-post-button-div', function( event ) {

            var bodyclasses = $(this).attr('class');
            if ( -1 !== bodyclasses.indexOf( 'wpplugin-save-post-button-div-alreadysaved' ) ){
                ...
                var postid = wppluginToplevelPhpVariables.CURRENT_POST_ID;
                var userid = wppluginToplevelPhpVariables.USER_WPID;

                  // Make Ajax call
                var data = {
                    'action': 'wpplugintoplevel_save_user_post_action',
                    'security': wppluginToplevelPhpVariables.adminnonce3,
                    'postid': postid,
                    'userid': userid,
                };
                ...
                $.post( ajaxurl, data, function( response ) {
                    ...
                    if ( '1' === response ) {
                        $( '.wpplugin-save-post-button-top-container' ).remove();
                        $( '.entry-title' ).after('<div class="wpplugin-save-post-button-top-container"><div class="wpplugin-save-post-button-div wpplugin-save-post-button-div-loggedin wpplugin-save-post-button-div-alreadysaved"><p>Success! You saved this post!</p><img src="' + wppluginToplevelPhpVariables.WPPLUGINTOPLEVEL_ROOT_IMG_URL + 'postalreadysaved.png"/></div><div class="wpplugin-spinner"></div><div class="wpplugin-save-post-response"></div></div>');
                    }
                ...
                if ( ( null !== wppluginToplevelPhpVariables.USER_SAVED_POST_IDS ) && ( '' !== wppluginToplevelPhpVariables.USER_SAVED_POST_IDS ) ) {
                    ...
                    for (var i = ids.length - 1; i >= 0; i--) {
                        if ( ids[i] == wppluginToplevelPhpVariables.CURRENT_POST_ID ) {
                            ...
                            $( '.entry-title' ).after('<div class="wpplugin-save-post-button-top-container"><div class="wpplugin-save-post-button-div wpplugin-save-post-button-div-loggedin wpplugin-save-post-button-div-alreadysaved"><p>You\'ve already saved this post!</p><img src="' + wppluginToplevelPhpVariables.WPPLUGINTOPLEVEL_ROOT_IMG_URL + 'postalreadysaved.png"/></div><div class="wpplugin-spinner"></div><div class="wpplugin-save-post-response"></div></div>');
                            set_flag = true;
                            break;
                        } 
                    }
